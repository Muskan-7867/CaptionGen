...
const LinkedInUI: React.FC<LinkedInUIProps> = ({ content }) =>{
  ...
  <div className="flex flex-col max-w-2xl sm:w-96 p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
    <div className="flex space-x-4">
      ...
      <button onClick={()=>copyCaption(content!)} className="bg-red-50 border">
        copy
      </button>
    </div>
    <div>
    ...
    <div>
      <img
        src="https://th.bing.com/th/id/R.ac0616f8e5c1ab1db96868e247d9e50b?rik=fK821HL3oYSoMA&riu=http%3a%2f%2fimg.vertouk.com%2f970x720%2feeeeee%2f005696%2feeeeee%2f%3fshowres%3dfalse%26request%3d%2fimages%2fcontent%2foptions%2f398_larger_970x720.jpg&ehk=GnlzxwNVdlexiIDjZPRxAGfrCQ00UJdgqXVf8L7plzY%3d&risl=&pid=ImgRaw&r=0"
        alt="Post Image"
